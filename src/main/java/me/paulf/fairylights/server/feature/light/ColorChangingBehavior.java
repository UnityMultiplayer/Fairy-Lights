...
public class ColorChangingBehavior implements ColorLightBehavior {
    ...
    public static boolean exists(final ItemStack stack) {
        return stack.has(FLComponents.COLORS);
    }
}
